---
title: "2023 Q4 EPI eHMIS data quality report"
...
For health facility data by district click [Here!](https://amanyiraho.shinyapps.io/GEEKS-DQ-SS-prioritization-tool/)
...
#|   
plot_ug_map(data = plot_data,fill = missing_reports, title = "Missing reports" )
...
#|   - "Summary of the districts"
#|   
plot_ug_map(data = plot_data,fill = neg_dropout_rate_dpt1_3,  title = "Negative Dropout rate")
...
#|   - "Summary of the districts"
#|   
plot_ug_map(data = plot_data,fill = discrepancy_dpt3_pcv3, title = "Discrepancy between DPT3 and PCV3")
...
#|   - "Summary of the districts"
#|   
plot_ug_map(data = plot_data,fill = neg_wastage_rates_dpt, title = "Negative wastage rate for DPT")
