---
title: "EPI eHMIS data quality dashboard"
format: 
  dashboard:
    orientation: rows
    nav-buttons: 
...
mutate( missing_reports = Expected.reports - Actual.reports, 
  ...
  filter( !(is.na(missing_reports)& is.na(neg_dropout_rate_dpt1_3) & 
   ...
   # mutate(neg_dropout_rate_dpt1_3 = case_when(missing_reports == TRUE ~ NA,
   #                                           missing_reports == FALSE ~ neg_dropout_rate_dpt1_3),
   #        discrepancy_dpt3_pcv3 = case_when(missing_reports == TRUE ~ NA,
   #                                           missing_reports == FALSE ~ discrepancy_dpt3_pcv3),
   #        neg_wastage_rates_dpt = case_when(missing_reports == TRUE ~ NA,
   #                                           missing_reports == FALSE ~ neg_wastage_rates_dpt)) |> 
